...
import com.dinus.yuditarum.realtimelocationtracking.Model.Tracking;
import com.dinus.yuditarum.realtimelocationtracking.Model.User;
...
public class ListOnline extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks,
    ...
    FirebaseRecyclerAdapter<com.dinus.yuditarum.realtimelocationtracking.Model.User,ListOnlineViewHolder> adapter;
    ...
    private void setupSystem() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if(dataSnapshot.getValue(Boolean.class))
                {
                    ...
                    counterRef.child(FirebaseAuth.getInstance().getCurrentUser().getUid())
                            .setValue(new com.dinus.yuditarum.realtimelocationtracking.Model.User(FirebaseAuth.getInstance().getCurrentUser().getEmail(),"Online"));
                    adapter.notifyDataSetChanged();
                }
            }
        ...
        counterRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                {
                    com.dinus.yuditarum.realtimelocationtracking.Model.User user = postSnapshot.getValue(com.dinus.yuditarum.realtimelocationtracking.Model.User.class);
